...
import sty from "./PlasmicButton.module.css"; // plasmic-import: WM-lPP1ZZ5DTBT/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___2InSi)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__zp7Fh)}
                role={"img"}
              />
            ),
